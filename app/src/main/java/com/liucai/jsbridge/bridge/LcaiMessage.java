...
public class LcaiMessage {
    ...
    public static LcaiMessage toObject(String jsonStr) {
    ...
    public static List<LcaiMessage> toArrayList(String jsonStr){
        List<LcaiMessage> list = new ArrayList<LcaiMessage>();
        try {
